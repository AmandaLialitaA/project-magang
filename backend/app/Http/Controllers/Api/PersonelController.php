    ...
    public function show(Request $request, $nrp)
    {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                // ── Field status ──
                'cuti_mulai' => $p->cuti_mulai,
                'cuti_selesai' => $p->cuti_selesai,
                'pendidikan_lokasi' => $p->pendidikan_lokasi,
                'pensiun_mulai' => $p->pensiun_mulai,
                // ── Field penempatan ──
                'lokasi_penempatan' => $p->lokasi_penempatan,
    ...
    public function store(Request $request)
    {
        try {
            $request->validate([
                ...
                'cuti_mulai' => 'nullable|date',
                'cuti_selesai' => 'nullable|date',
            ...
            $personel = Personel::create([
                ...
                'pendidikan_lokasi' => $request->pendidikan_lokasi,
                'pensiun_mulai' => $request->pensiun_mulai,
                // ── Field penempatan ──
        ...
        try {
            ...
            if ($request->hasFile('foto')) {
                try {
                    ...
                    // skip update foto kalau storage tidak tersedia
                }
            }
