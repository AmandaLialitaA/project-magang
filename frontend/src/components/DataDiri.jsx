...
export default function DataDiri({ nrp, onNavigate, onLogout }) {
  ...
  function handleEdit() {
    setEditData({
      ...
      lokasi_penempatan: personel.lokasi_penempatan || '',
    });
    setEditMode(true);
  }
  ...
  async function handleUnduhPDF() {
    ...
    const identitas = [
      ...
      ["Lokasi Penempatan", personel.lokasi_penempatan || "–"],
    ];
                ...
                {editMode ? (
                  <form onSubmit={handleSaveChanges}>
                    <div className="identity-grid">
                      {[
                        ...
                        ["Lokasi Penempatan", "lokasi_penempatan", "text"],
                  ...
                  <div className="identity-grid">
                    {[
                      ...
                      ["Asal Masuk Dikma", personel.asal_masuk_dikma || "–"],
                      ["Angkatan Dikma", personel.angkatan_dikma || "–"],
                      // ── Lokasi Penempatan (selalu tampil) ──
                      ["Lokasi Penempatan", personel.lokasi_penempatan || "–"],
        ...
        <div className="right-panel">
          ...
          <div className="lokasi-card">
            ...
            <div className="lokasi-fields">
              ...
              <div className="lokasi-field">
                <span className="lokasi-field-label">Penempatan:</span>
                <span className="lokasi-field-value">{personel.lokasi_penempatan || "–"}</span>
              </div>
              <div className="lokasi-field">
