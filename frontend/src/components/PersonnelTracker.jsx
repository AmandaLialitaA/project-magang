    ...
    try {
      ...
      if (res.ok || data?.success) {
        ...
        setFormData({
          ...
          cuti_mulai: "", cuti_selesai: "", pendidikan_lokasi: "", pensiun_mulai: "",
          lokasi_penempatan: "",
        });
                                    ...
                                    try {
                                      ...
                                      if (d.success) {
                                        setEditData({
                                          ...
                                          lokasi_penempatan: d.data.lokasi_penempatan || '',
                                          foto_baru: null,
                                        });
              ...
              <form onSubmit={handleAddPersonnel}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "16px", marginBottom: "32px" }}>
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" placeholder="Contoh: Lanud Iswahjudi, Madiun" style={inputStyle} value={formData.lokasi_penempatan || ""} onChange={(e) => setFormData({ ...formData, lokasi_penempatan: e.target.value })} />
                  </div>
                </div>
            ...
            <div className="modal-body" style={{ overflowY: "auto", padding: "24px" }}>
              <form onSubmit={handleEditPersonnel}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "16px", marginBottom: "32px" }}>
                  ...
                  <div className="form-group">
                    <label style={labelStyle}>Lokasi Penempatan</label>
                    <input type="text" placeholder="Contoh: Lanud Iswahjudi, Madiun" style={inputStyle} value={editData.lokasi_penempatan || ""} onChange={(e) => setEditData({ ...editData, lokasi_penempatan: e.target.value })} />
                  </div>
                </div>
